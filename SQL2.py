...
#loop everything if customer wants to make another order
while True:    
    ...
    while True:
        ...
        if Customer_name == "" or  Customer_name.isspace() or Customer_name.isdigit():
            ...
            break
    #asking the customer what drink theyd like
    while True:
        with sqlite3.connect("BubbleLin.db") as connection:
            while True:    
                try:
    ...
    #asking what additive they'd like in their drink   
    while True:
        with sqlite3.connect("BubbleLin.db") as connection:
            while True: 
                try:
    ...
    Loop = input('''Would you like to order more? Please type "Yes" to continue or "No" to end the program''')
    if Loop == "Yes":
        continue
    if table == "No":
        break
    if table == "" or  table.isspace() or table.isdigit():
        ...
        print('You didnt type "Yes" or "No", else the ordering system will not work')
print('''Thank you for using my bubble tea ordering system''')
